...
<div className={'w-full flex flex-col lg:grid lg:grid-flow-row-dense lg:grid-cols-5 gap-2'}>
    ...
    >
        ...
        <div className={'font-bold text-2xl lg:text-4xl text-white dark:text-black z-10 underline decoration-emerald-400 underline-offset-4 leading-relaxed'}>
           Chemistry .
        </div>
    </div>
