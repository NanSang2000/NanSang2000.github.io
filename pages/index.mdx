  ...
  >
    ...
    <div className={'h-full z-10 p-4 md:p-6 grid w-full items-stretch content-start'}>
      ...
      <div className={'mt-4 md:mt-3 w-full flex flex-col justify-center items-end space-y-2 md:space-y-1'}>
        <Link href={'https://www.linkedin.com/in/nan-sang/'} target={'_blank'} className={'flex w-full justify-end items-center group'}>
        ...
        <Link href={'https://github.com/nansang2000'} target={'_blank'} className={'flex w-full justify-end items-center group'}>
        ...
        <Link href={'mailto:nansang2000@gmail.com'} target={'_blank'} className={'flex w-full justify-end items-center group'}>
