        ...
        <div className={'w-full h-full lg:ml-5 flex flex-col lg:flex-row justify-center lg:justify-start items-center'}>
            <div className={'flex flex-col'}>
              ...
              <div className={'text-2xl gap-2 flex h-max justify-start items-center text-black'}>
                <GoStar className={'text-blue-500'} /> {stars}
              </div>
            </div>
          <div className={'flex flex-col lg:ml-5'}>
            ...
            <div className={'text-2xl gap-2 flex h-max justify-start items-center text-black'}>
              <GoRepoForked className={'text-blue-500'} /> {forks}
            </div>
          </div>
          <div className={'flex flex-col lg:ml-5'}>
            <div className={'text-sm lg:text-base flex h-max justify-center items-center text-black'}>
            ...
            <div className={'text-2xl gap-2 flex h-max justify-start items-center text-black'}>
              <GoRepo className={'text-blue-500'} /> {repos}
            </div>
          </div>
          <div className={'flex flex-col lg:ml-5'}>
            <div className={'text-sm lg:text-base flex h-max justify-center items-center text-black'}>
            ...
            <div className={'text-2xl gap-2 flex h-max justify-start items-center text-black'}>
              <GoEye className={'text-blue-500'} /> {followers}
            </div>
          </div>
        </div>
    )
...
<div className={'lg:grid lg:grid-cols-2 z-10'}>
 ...
 <div>Sang</div>
        ...
        <div className={'text-xl lg:text-4xl font-bold text-gray-600 dark:text-gray-320 -mt-2'}>
            An energetic <b className={'underline decoration-wavy underline-offset-2 decoration-blue-500'}>Machine Learning</b> learner.
        </div>
        <Button href={'/note'} className={'mt-6'}>
            view my garden
        </Button>
...
<div className={'w-full flex flex-col lg:grid lg:grid-flow-row-dense lg:grid-cols-5 gap-2'}>
    ...
    >
        ...
        <div className={'font-bold text-2xl lg:text-2xl text-white dark:text-black z-10 underline decoration-emerald-400 underline-offset-4 leading-relaxed'}>
            ...
            <div className={'flex w-full flex-col'}>
              <div className={'mt-3 w-full bg-gray-800 px-3 py-3 bg-opacity-90 rounded-md flex justify-between items-center'}>
                    ...
                    <div className={'text-white font-bold text-base lg:text-lg'}>
                        A <b className={'text-orange-600'}>A full-stack developer</b> .
                    </div>
              </div>
              <div className={'mt-3 w-full bg-gray-800 px-3 py-3 bg-opacity-90 rounded-md flex justify-between items-center'}>
                    <FiGlobe className={'text-2xl text-white'} />
                    <div className={'text-white font-bold text-base lg:text-lg'}>
                        Now Studying at <b className={'text-green-600'}>Unimelb.</b>
                    </div>
                </div>
              <div className={'mt-3 w-full bg-gray-800 px-3 py-3 bg-opacity-90 rounded-md flex justify-between items-center'}>
                    <FiBookOpen className={'text-2xl text-white'} />
                    <div className={'text-white font-bold text-base lg:text-lg'}>
                        Major in <b className={'text-red-600'}>Data Science.</b>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div className={'flex relative overflow-hidden bg-blue-100 col-span-3 h-max lg:h-96 w-full rounded-2xl'}>
        <div className={'bg-black bg-gray-300 absolute w-full h-full opacity-80 z-0 backdrop-blur-lg'}></div>
        <div className={'w-96 h-96 bg-orange-300 rounded-full absolute blur-3xl left-24'}></div>
        <div className={'w-96 h-96 bg-pink-200 rounded-full absolute blur-3xl right-24'}></div>
        <div className={'h-full z-10 p-6 grid  w-full items-stretch content-start'}>
            <div className={'text-3xl font-bold text-white underline decoration-blue-600 underline-offset-4 bg-black w-max px-2 py-2'}>
                GitHub
            </div>
            <div className={'flex flex-col lg:flex-row w-full mt-8 justify-start items-center'}>
                  <img src={'https://avatars.githubusercontent.com/u/125345731'} className={'w-20 h-20 rounded-full'} />
...
export function VistorDemo () {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-black dark:text-white">
      ...
      <div className="text-xl mt-2">Visitor Count</div>
      {ip && (
        <div className="mt-4 flex flex-col items-center">
          <div className="text-sm text-gray-600 dark:text-gray-400">最近访问IP</div>
          <div className="text-lg font-medium">{ip}</div>
        </div>
      )}
